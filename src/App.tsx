...
function App() {
  ...
  const cardsDataEn = [
    ...
    },
    {
      ...
      technologies: ["HTML", "CSS", "JavaScript"],
      description:
        "Starting my journey with JavaScript, I completed several exercises to understand its logic, functions, and possibilities. Here, I gathered all of them to better showcase what was done in each one.",
      image: "javascript.png",
      link: "projects/javascript/index.html",
    },
    {
      ...
      technologies: ["HTML", "CSS", "JavaScript"],
      description:
        "In this project, I learned core JavaScript fundamentals such as onClick functions, retrieving elements to use in JS functions, modifying innerHTML, and common functions like Math.random.",
      image: "par_impar.png",
      link: "projects/par_impar/par_ou_impar.html",
    },
    {
      date: "AUGUST 16, 2023",
      title: "JS FILES & NEW POSSIBILITIES",
      name: "Rock Paper Scissors",
      technologies: ["HTML", "CSS", "JavaScript"],
      description:
        "While learning how to use .js files, I was also taught how to work with images and colors, as well as handle more complex logic and possibilities.",
      image: "jokenpo.png",
      link: "projects/jokenpo/jokenpo.html",
    },
    {
      ...
      technologies: ["HTML", "CSS", "PHP", "MySQL", "Bootstrap"],
      description:
        "In this team project, we were introduced to GitHub. Although I already had some prior knowledge, this experience allowed me to deepen my understanding by collaborating and coding alongside my classmates.",
      image: "chathi.png",
      link: "projects/chathi/interface/index.php",
    },
    {
      ...
      technologies: ["HTML", "CSS", "PHP", "MySQL"],
      description:
        "In this very important project, I learned the basics of account creation. Beyond registration, I also implemented login functionality that maintains the user session, protected pages that are blocked when the user is not logged in, and, of course, a logout feature.",
      image: "sessao.png",
      link: "projects/sessao/index.php",
    },
    {
      ...
      technologies: ["HTML", "CSS", "PHP", "MySQL"],
      description:
        "After a semester focused on Object-Oriented Programming in Python, we finally applied what we learned to web development by creating a very simple interface website with the goal of testing OOP concepts in PHP.",
      image: "poo.png",
      link: "projects/poo/index.php",
    },
    {
      ...
      technologies: ["HTML", "CSS", "JavaScript"],
      description:
        "During Spanish classes, one of our assessments was to add a translator to our Integrative Project. For testing purposes, I created this small website to experiment with translating website elements into Spanish.",
      image: "espanhol.png",
      link: "projects/espanhol/teste.html",
    },
    {
      date: "DECEMBER 1, 2023",
      title: "PRACTICING OBJECTS",
      name: "Premium Blog",
      technologies: ["HTML", "CSS", "PHP", "MySQL"],
      description:
        "Continuing my OOP training in web development, we built a small blog with users and their posts. We were also required to customize our blogs, so I added a paywall for content beyond a character limit, as well as a feature where users could pay per section to earn stars in the text.",
      image: "blog.png",
      link: "projects/blog/index.php",
    },
    {
      ...
      technologies: ["HTML", "CSS", "React", "TypeScript"],
      description:
        "Seeking to expand my skill set, I started a React course focused on understanding component logic, which I practiced in this project.",
      image: "react.png",
      link: "projects/react/index.html",
    },
    {
      date: "NOVEMBER 24, 2024",
      title: "IMPROVING REACT SKILLS",
      name: "Gasoline vs. Alcohol",
      technologies: ["HTML", "CSS", "React", "TypeScript"],
      description:
        "Further improving my React skills, I built the classic project that compares the cost-benefit between gasoline and alcohol.",
      image: "gasolina.png",
      link: "projects/gasolina/index.html",
    },
  ];
